...
export default function AboutUs() {
  ...
  return (
    <div className="flex flex-col font-inter">
      ...
      <div className="flex h-[205px] w-full flex-col items-center">
        <Carousel
          opts={{ loop: true }}
          ...
          <CarouselContent>
            <CarouselItem className="pt-10 md:basis-1/2 lg:basis-1/4">
              <div className="flex h-[122px] w-[248px] flex-col items-center justify-center">
                <h1 className="text-[40px] font-bold text-blue-800">+72.544</h1>
            ...
            <CarouselItem className="pt-10 md:basis-1/2 lg:basis-1/4">
              <div className="flex h-[122px] w-[248px] flex-col items-center justify-center">
                <h1 className="text-[40px] font-bold text-blue-800">+38.025</h1>
            ...
            <CarouselItem className="pt-10 md:basis-1/2 lg:basis-1/4">
              <div className="flex h-[122px] w-[248px] flex-col items-center justify-center">
                <h1 className="text-[40px] font-bold text-blue-800">+6.633</h1>
            ...
            <CarouselItem className="pt-10 md:basis-1/2 lg:basis-1/4">
              <div className="flex h-[122px] w-[248px] flex-col items-center justify-center">
                <h1 className="text-[40px] font-bold text-blue-800">+1.977</h1>
            ...
            <CarouselItem className="pt-10 md:basis-1/2 lg:basis-1/4">
              <div className="flex h-[122px] w-[248px] flex-col items-center justify-center">
                <h1 className="text-[40px] font-bold text-blue-800">+28.070</h1>
            ...
            <CarouselItem className="pt-10 md:basis-1/2 lg:basis-1/4">
              <div className="flex h-[122px] w-[248px] flex-col items-center justify-center">
                <h1 className="text-[40px] font-bold text-blue-800">+9.463</h1>
      ...
      <div className="flex flex-col items-center py-10 text-center dark:text-zinc-300">
        <div className="flex flex-col pb-10 font-bold md:text-4xl">
          <div>Toop</div>
          <div>Inovação e Agilidade</div>
        </div>

        <div className="max-w-[50%] pb-16">
      ...
      <div className="flex flex-col gap-[100px] px-[20%]">
        <div className="relative flex flex-row">
          <div className="absolute inset-0 left-[-20px] top-[80px] -z-10 h-[200px] w-[250px] rounded-xl bg-blue-700" />
        ...
        <div className="relative flex flex-row justify-end pl-[20%]">
          <div className="flex flex-col justify-center pr-10 text-sm font-bold dark:text-zinc-300">
            <h1 className="pb-4 text-right text-2xl">
              Somos a <span className="text-blue-700">ATM Outsourcing</span>
            </h1>
            <p className="text-right text-xl">a solução mais completa</p>
            <p className="text-right text-xl">em telefonia móvel corporativa</p>
          </div>

          <div className="absolute inset-0 left-[75%] top-[35%] -z-10 h-[72%] w-[27%] rounded-xl bg-blue-700" />
      ...
      <div className="flex flex-row justify-center gap-10 pb-20 md:min-h-[700px]">
        <div className="flex max-w-[400px] flex-col items-center rounded-xl border p-10 shadow-[0_0_15px_5px_rgba(59,130,246,0.5)]">
          <svg
            className="h-[200px] w-[200px] text-blue-800"
            stroke="currentColor"
            fill="currentColor"
            strokeWidth="0"
            viewBox="0 0 576 512"
          ...
          <p className="pb-10 text-4xl font-bold text-blue-700">Propósito</p>
        ...
        <div className="flex max-w-[400px] flex-col items-center rounded-xl border p-10 shadow-[0_0_15px_5px_rgba(59,130,246,0.5)]">
          ...
          <p className="pb-10 text-4xl font-bold text-blue-700">Missão</p>
          <p className="text-center">
      ...
      <div className="flex h-screen flex-row items-center justify-center gap-10">
        <Image src={valores} alt="Valores" className="w-[40%]" />
        <Image src={grupoAtm} alt="Valores" className="w-[40%]" />
      </div>
    </div>
  )
}
