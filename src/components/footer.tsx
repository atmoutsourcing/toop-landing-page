...
export function Footer() {
  return (
    <footer className="mt-4 flex w-full flex-col gap-8 border-t-2 p-12">
        ...
        <div className="gap-24 md:grid md:grid-cols-4">
          <div className="flex flex-col gap-2 pb-4 md:items-center">
            ...
            <div className="md:space-y-2">
              <span className="flex cursor-pointer items-center gap-2 text-sm font-bold text-zinc-600 hover:text-zinc-800 hover:underline dark:text-zinc-300">
                Suporte
              </span>
          ...
          <div className="flex flex-col text-xl font-bold tracking-tighter">
            <div className="flex flex-col gap-2 md:items-center">
              <div>
                <span className="text-base font-bold underline underline-offset-4 dark:text-zinc-400">
                  Horários comercial
